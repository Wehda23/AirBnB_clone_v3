...
class FileStorage:
    ...
    def get(self, cls, id):
        ...
        Returns:
            objects: object in case object exists otherwise None.
        """
    ...
    def count(self, cls=None):
        ...
        Args:
            - cls (object): class name (optional)

        Return:
            - Number of objects as in Python Integer.
        """
        # Return the lengths of the count
